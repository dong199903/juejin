<template>
  <div>
    ...
    <img :src="loginSrc" alt="表情图" class="loginImages" />
     ...
     <h1 class="login_title">手机重置密码</h1>
...
<el-form-item label="">
    ...
    <el-button type="primary" @click="resetPwd" style="width:100%;margin-bottom: 10px;">
    修改</el-button>
    </el-form>

    <div class="else">
    <el-link :underline="false" type="primary" @click="toEmailResetPwd">邮箱重置密码</el-link>
    ...
    methods: {
      resetPwd() {
        if(this.phoneLoginForm.phone===''){
          ...
          this.$message("请输入验证码");
        }else if(this.phoneLoginForm.newPwd.length<6){
      ...
      toEmailResetPwd(){
        this.$router.push({path:'/emailresetpwd'});
      },
      choosePrefix0(){
